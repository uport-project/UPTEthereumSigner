...
#import "../../UPTEthereumSigner/CoreBitcoin.framework/Headers/BTCKey.h"
#import <UPTEthereumSigner/UPTEthSigner.h>
#import <UPTEthereumSigner/UPTEthSigner+Utils.h>
...
//    NSLog( @"privateKeyDAta testSsignJwt length -> %@", @(privateKeyData32Bytes.length));
  ...
  NSArray *referenceData = @[
   ...
   @"hex": @"",
     @"signature": @"sg1oJ7J_f2pWaX2JwqzA61oWMUK5v0LYVxUp3PvG7Y25CVYWPyQ6UhA7U9d4w3Ny74k7ryMaUz7En5RSL4pyXg"
   ...
   @{ @"encoded": @"ZXlKMGVYQWlPaUpLVjFRaUxDSmhiR2NpT2lKRlV6STFOa3NpZlEuZXlKcGMzTWlPaUl6TkhkcWMzaDNkbVIxWVc1dk4wNUdRemgxYWs1S2JrWnFZbUZqWjFsbFYwRTRiU0lzSW1saGRDSTZNVFE0TlRNeU1URXpNekF3TUN3aVkyeGhhVzF6SWpwN0ltNWhiV1VpT2lKQ2IySWlmU3dpWlhod0lqb3hORGcxTkRBM05UTXpNREF3ZlE=",
      ...
      @"signature": @"XJlwY1KrGRa53oHjz6vjsJadn-Er1ZW6WvLg1KiBQonV9vwqan-hAvn4tNFh7qyZMxxa3xyO7wN7GNuz6_UJ5Q"
  },
   @{ @"encoded": @"ZXlKMGVYQWlPaUpLVjFRaUxDSmhiR2NpT2lKRlV6STFOa3NpZlEuZXlKcGMzTWlPaUl6TkhkcWMzaDNkbVIxWVc1dk4wNUdRemgxYWs1S2JrWnFZbUZqWjFsbFYwRTRiU0lzSW1saGRDSTZNVFE0TlRNeU1URXpNeXdpWTJ4aGFXMXpJanA3SW01aGJXVWlPaUpDYjJJaWZTd2laWGh3SWpveU5EZzFNekl4TVRNemZR",
      ...
      @"signature": @"yHkI8fY42iquI-3CSM0k75cJQ4X1DoiGV436YgFQIhJUvjO17q01KhJv2jXviCQrstYe7MZpmJE4SxTvCoC1qQ" }
];
...
//    NSLog(@"decoded payload: %@", payloadString);
    [UPTEthSigner signJwt:referenceAddress userPrompt:@"test signing data" data:payload result:^(NSData *signature, NSError *error) {
      NSString *base64Signature = [signature base64EncodedStringWithOptions:0];
//      NSLog(@"base64sig: %@", base64Signature);
      NSString *webSafeBase64Signature = [UPTEthSigner URLEncodedBase64StringWithBase64String:base64Signature];
//      NSLog(@"referenceSignature -> %@\nand actual signature -> %@", example[@"signature"], webSafeBase64Signature);
      XCTAssertEqualObjects(webSafeBase64Signature, example[@"signature"], @"signature did not match");
      [kpExpectations fulfill];
    }];
  }];
  [self waitForExpectationsWithTimeout:1 handler:^(NSError *error) {
...
//            NSLog(@"signature: %@", signature);
            ...
            [UPTEthSigner signJwt:kp[@"address"] userPrompt:@"test signing data" data:jwtData result:^(NSData *signature, NSError *error) {
              XCTAssertNil(error, @"error signing transaction: %@", error);
              NSString *base64Signature = [signature base64EncodedStringWithOptions:0];
              NSString *webSafeBase64Signature = [UPTEthSigner URLEncodedBase64StringWithBase64String:base64Signature];
              XCTAssertEqualObjects(webSafeBase64Signature, kp[@"jwtsig"], @"signature did not match");
              [kpExpectations fulfill];
            }];
          } else {
//            NSLog(@"error signing transaction : %@", error);
