...
//
//  Created by Cornelis van der Bent on 16/01/2019.
...
@interface UPTEthSignerTests : XCTestCase
@end

@implementation UPTEthSignerTests
...
- (void)testEIP155Example
{
    ...
    XCTAssertEqualObjects(sig[@"r"], [BTCDataFromHex(@"28EF61340BD939BC2195FE537567866003E1A15D3C71FF63E1590620AA636276")
                                      base64EncodedStringWithOptions:0]);
    XCTAssertEqualObjects(sig[@"s"], [BTCDataFromHex(@"67CBE9D8997F761AECB703304B3800CCF555C9F3DC64214B297FB1966A3B6D83")
                                      base64EncodedStringWithOptions:0]);
}
